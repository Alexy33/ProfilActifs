...
const fieldClass =
  "h-11 rounded-xl border-0 bg-[#ebf0f7] px-3.5 text-base shadow-[inset_4px_4px_8px_#c5d1e0,inset_-4px_-4px_8px_#ffffff] placeholder:text-[#41556E] focus-visible:border-0 focus-visible:ring-2 focus-visible:ring-[#1B3A6B]/30 md:text-base";
      ...
      <form onSubmit={handleSubmit} className="grid gap-5">
        ...
        */}
        <fieldset className="grid gap-2">
          <legend className="mb-2 text-sm text-[#22334D]">Je crée un compte en tant que</legend>
              ...
              <button
                ...
                className={`flex items-start gap-3 rounded-xl px-4 py-3 text-left transition-colors ${
                  role === id
                    ...
                    : "bg-[#ebf0f7] text-[#22334D] shadow-[inset_4px_4px_8px_#c5d1e0,inset_-4px_-4px_8px_#ffffff] hover:bg-[#D1DEF0]"
                }`}
              >
                ...
                <span>
                  ...
                  <span
                    className={`mt-0.5 block text-sm ${role === id ? "text-white/80" : "text-[#41556E]"}`}
                  >
                    {hint}
                  </span>
                </span>
        ...
        <div className="grid gap-2">
          ...
          <Input
            ...
            className={fieldClass}
          />
          <p className="text-sm text-[#41556E]">Doit contenir au moins 8 caractères.</p>        </div>
        ...
        */}
        {role === "recruiter" ? (
          <fieldset className="grid gap-5 rounded-2xl border border-[#1B3A6B]/20 bg-[#F5F9FE] p-5">
            <legend className="flex items-center gap-2 px-2 text-sm font-semibold text-[#22334D]">
              <Building2 aria-hidden="true" className="size-4" />
              Votre entreprise
            </legend>

            <div className="grid gap-2">
              <Label htmlFor="companyName" className="text-sm text-[#22334D]">Raison sociale</Label>
              <Input
                id="companyName"
                value={company.name}
            ...
            <div className="grid gap-2">
              <Label htmlFor="siren" className="text-sm text-[#22334D]">SIREN</Label>
              <Input
                id="siren"
                value={company.siren}
                ...
                className={fieldClass}
              />
              <p id="siren-help" className="text-sm text-[#41556E]">
            ...
            <div className="grid gap-2">
              <Label htmlFor="position" className="text-sm text-[#22334D]">
            ...
            <div className="grid gap-2">
              <Label htmlFor="address" className="text-sm text-[#22334D]">Adresse</Label>
              <Input
                id="address"
            ...
            <div className="grid gap-5 sm:grid-cols-[minmax(0,140px)_minmax(0,1fr)]">
              <div className="grid gap-2">
                <Label htmlFor="postalCode" className="text-sm text-[#22334D]">Code postal</Label>
                <Input
                  id="postalCode"
              ...
              <div className="grid gap-2">
                <Label htmlFor="companyCity" className="text-sm text-[#22334D]">Ville</Label>
                <Input
                  id="companyCity"
                  value={company.city}
            ...
            <div className="grid gap-2">
              <Label htmlFor="companySector" className="text-sm text-[#22334D]">Secteur d&apos;activité</Label>
              <select
                id="companySector"
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <div className="grid gap-2">
                <Label htmlFor="companyPhone" className="text-sm text-[#22334D]">
                  Téléphone <span className="font-normal text-[#41556E]">(facultatif)</span>
                </Label>
                <Input
                  id="companyPhone"
                  type="tel"
              ...
              <div className="grid gap-2">
                <Label htmlFor="companyWebsite" className="text-sm text-[#22334D]">
                  Site web <span className="font-normal text-[#41556E]">(facultatif)</span>
                </Label>
                <Input
                  id="companyWebsite"
        ...
        <Button
          ...
          className="mt-1 h-11 w-full rounded-xl bg-[#22334D] text-base text-white shadow-[6px_6px_12px_#c5d1e0,-6px_-6px_12px_#ffffff] hover:bg-[#1E293B] hover:shadow-[inset_3px_3px_6px_#273D4F,inset_-3px_-3px_6px_#4A6B8A]"
        >
