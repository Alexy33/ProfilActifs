...
export function RecruiterDashboard() {
  ...
  return <main className="mx-auto w-full max-w-[1480px] px-5 pb-24 pt-8 md:px-10 md:pt-12 lg:px-6">
    <header className="flex flex-wrap items-end justify-between gap-5 border-b border-[#1B3A6B]/15 pb-7"><div><p className="font-mono text-xs font-semibold uppercase tracking-wider text-[#41556E]">Espace recruteur</p><h1 className="mt-3 text-4xl font-extrabold uppercase text-[#22334D] md:text-5xl">Suivez vos <span className="text-[#1B3A6B]">candidats.</span></h1></div><Link href="/catalogue" className="inline-flex h-11 items-center gap-2 rounded-xl bg-[#2d3748] px-5 text-sm font-semibold text-white hover:bg-[#1E293B]"><Search className="size-4" /> Parcourir le catalogue</Link></header>
